...
async function tdxStart() {
    ...
    if (usePairingCode && !tdx.authState.creds.registered) {
        ...
        say("Create By devorsix\nYOUTUBE : devorsixcore\nTelegram : imdevorsix\nInstagram : justddevorsix\n", {
            font: 'console',
            align: 'center',
            gradient: [randomcolor, randomcolor]
        });
        let phoneNumber = await question(`<!> MASUKAN NOMOR TELPON DENGAN BERAWALAN KODE NEGARA (JANGAN GUNAKAN 0). ❌\n<✓> EXAMPLE : 62878890000\n\n <+> NOMOR LU : `);
